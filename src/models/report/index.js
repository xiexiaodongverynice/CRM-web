    ...
    setup({ dispatch, history }) {
      return history.listen((location) => {
        ...
        const match = pathToRegexp(
          '/report/(workingDetail|doctorDetail|doctorCallDetail|doctorCallRateDetail|doctorCallCoverDetail|validDoctorCallCoverDetail|eventDetail|coachDetail)?',
        ).exec(pathname);
        if (match) {
