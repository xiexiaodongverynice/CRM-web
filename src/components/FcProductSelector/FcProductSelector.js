...
import * as styles from './FcProductSelector.less';
import * as recordService from '../../services/object_page/recordService';
import * as crmIntlUtil from '../../utils/crmIntlUtil';
import consoleUtil from '../../utils/consoleUtil';

const CheckboxGroup = Checkbox.Group;
class FcProductSelector extends React.Component {
  constructor(props) {
    super(props);
  ...
  fetch =() => {
    ...
    const dataDeal = {
      ...
      orderBy: _.get(data, 'default_sort_by', _.get(data, 'orderBy', 'update_time')),
      order: _.get(data, 'default_sort_order', _.get(data, 'order', 'desc')),
...
FcProductSelector.propTypes = {
  fetch: PropTypes.object,
  onChangeSelect: PropTypes.func,
};

export default FcProductSelector;
