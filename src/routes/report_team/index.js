...
import { handleResult, mapStateToProps, barFill } from './helpers';
import { DateMonthDropDown } from './commonElements';
...
const ReportIndex = ({ dispatch, location, loading, result = {}, YM, activeTabKey }) => {
  ...
  if (is_SM) {
    eventData = [
      ...
      {
        name: crmIntlUtil.fmtStr('text.report.district_manager'),
        eventTarget: NumberOrEmpty(data.ManagerEventTarget),
        eventAchiRate: NumberOrEmpty(data.ManagerEventAchiRate),
        eventNumber: NumberOrEmpty(data.ManagerEventNumber),
      },
    ];
  } else {
    eventData = [
  ...
  return (
    <div className="k_container bg_white">
      ...
      <Tabs
        ...
        onChange={(index) => {
          dispatch({
            type: 'report_team_index/updateState',
            payload: {
              activeTabKey: index,
            },
          });
        ...
        <TabPane tab={crmIntlUtil.fmtStr('text.report.daily_statistics')} key="1">
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            <span className={styles['text-item']}>
              ...
              {_SM_text}: <strong>{WorkingDays}</strong>
            </span>
            <span className={cx(styles['text-item'], styles['text-item'])}>
              ...
              {_SM_text}: <strong>{WorkingDaysTarget}</strong>
            </span>
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report_team/workingDetail');
                }}
              >
          ...
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report_team/doctorDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <ResponsiveContainer height={200}>
            ...
            >
              ...
              <Bar
                dataKey="doctorTargetNumber"
                name={crmIntlUtil.fmtStr('text.report.the_standard_number_of_the_target_doctors')}
                fill={barFill.green}
                label
              />
              <Bar
                dataKey="doctorNumber"
                name={crmIntlUtil.fmtStr('text.report.the_number_of_the_target_doctors')}
                fill={barFill.blue}
                label
              />
            </BarChart>
          ...
          <Table dataSource={doctorNumberData} pagination={false}>
            <Column
              title={
                is_SM
                  ? `${crmIntlUtil.fmtStr(
                      'text.report.the_number_of_the_target_doctors',
                    )}(${crmIntlUtil.fmtStr('text.report.team_with_an_average')})`
                  : crmIntlUtil.fmtStr('text.report.the_number_of_the_target_doctors')
              }
        ...
        <TabPane tab={crmIntlUtil.fmtStr('text.report.visit_about')} key="2">
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report_team/doctorCallDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <ResponsiveContainer height={200}>
            <BarChart
              data={doctorCallNumberChartData}
            ...
            >
              ...
              <CartesianGrid strokeDasharray="3 3" />
              <Bar
                dataKey="avgCallTarget"
                fill={barFill.green}
                name={crmIntlUtil.fmtStr('text.report.the_standard_number_of_the_visits')}
                label
              />
              <Bar
                dataKey="avgCallNumber"
                fill={barFill.blue}
                name={crmIntlUtil.fmtStr('text.report.the_number_of_the_visits')}
                label
              />
            </BarChart>
          </ResponsiveContainer>
          ...
          <Table dataSource={doctorCallNumberTableData} pagination={false}>
            ...
            <Column
              title={crmIntlUtil.fmtStr(
                'text.report.the_standard_number_of_the_daily_visits_with_ppt',
              )}
            ...
            <Column
              title={crmIntlUtil.fmtStr(
                'text.report.the_achieving_rate_of_the_daily_visits_with_ppt',
              )}
          ...
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report_team/doctorCallRateDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            <span className={styles['text-item']}>
              {crmIntlUtil.fmtStr('text.report.the_coverage_rate_of_the_doctors')}
              {_SM_text}
            </span>
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report_team/doctorCallCoverDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <ResponsiveContainer height={300}>
            ...
            >
              ...
              <CartesianGrid strokeDasharray="3 3" />
              <Bar
                dataKey="doctorCoverRateTarget"
                fill={barFill.green}
                name={crmIntlUtil.fmtStr('text.report.the_standard_coverage_rate_of_the_doctors')}
                label
              />
              <Bar
                dataKey="doctorCoverRate"
                fill={barFill.blue}
                name={crmIntlUtil.fmtStr('text.report.the_coverage_rate_of_the_doctors')}
                label
              />
            </BarChart>
          </ResponsiveContainer>
          ...
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            <span className={styles['text-item']}>
              {crmIntlUtil.fmtStr('text.report.the_effective_coverage_rate_of_the_visits')}
              {_SM_text}
            </span>
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report_team/validDoctorCallCoverDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <ResponsiveContainer height={300}>
            ...
            >
              ...
              <CartesianGrid strokeDasharray="3 3" />
              <Bar
                dataKey="validDoctorCoverRateTarget"
                fill={barFill.green}
                name={crmIntlUtil.fmtStr(
                  'text.report.the_effective_standard_coverage_rate_of_the_visits',
                )}
                label
              />
              <Bar
                dataKey="validDoctorCoverRate"
                fill={barFill.blue}
                name={crmIntlUtil.fmtStr('text.report.the_effective_coverage_rate_of_the_visits')}
                label
              />
            </BarChart>
          </ResponsiveContainer>
          ...
          <Table dataSource={doctorCallData} pagination={false}>
            ...
            <Column
              title={crmIntlUtil.fmtStr(
                'text.report.the_achieving_rate_of_the_effective_coverage_by_visit',
              )}
        ...
        <TabPane tab={crmIntlUtil.fmtStr('text.report.event_about')} key="3">
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report_team/eventDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <ResponsiveContainer height={200}>
            ...
            >
              ...
              <Bar
                dataKey="eventTarget"
                name={crmIntlUtil.fmtStr('text.report.the_standard_of_the_event')}
                fill={barFill.green}
                label
              />
              <Bar
                dataKey="eventNumber"
                name={crmIntlUtil.fmtStr('text.report.the_complete_number_the_events')}
                fill={barFill.blue}
                label
              />
            </BarChart>
          ...
          <TabPane tab={crmIntlUtil.fmtStr('text.report.coach_about')} key="4">
            ...
            >
              ...
              <span className={utilitiesStyles['right']}>
                <a
                  onClick={() => {
                    hashHistory.push('/report_team/coachDetail');
                  }}
                >
                  {crmIntlUtil.fmtStr('text.report.details')}
                </a>
            ...
            <ResponsiveContainer height={300}>
              ...
              >
                ...
                <Bar
                  dataKey="coachTarget"
                  fill={barFill.green}
                  name={crmIntlUtil.fmtStr('text.report.the_standard_of_the_coachs')}
                  label
                />
                <Bar
                  dataKey="coachNumber"
                  fill={barFill.blue}
                  name={crmIntlUtil.fmtStr('text.report.the_number_the_coaches')}
                  label
                />
              </BarChart>
            </ResponsiveContainer>
