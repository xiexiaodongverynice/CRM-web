        ...
        <TabPane tab={crmIntlUtil.fmtStr('text.report.daily_statistics')} key="1">
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report/workingDetail');
                }}
              >
          ...
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report/doctorDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
        ...
        <TabPane tab={crmIntlUtil.fmtStr('text.report.visit_about')} key="2">
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report/doctorCallDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report/doctorCallRateDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report/doctorCallCoverDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report/validDoctorCallCoverDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
        ...
        <TabPane tab={crmIntlUtil.fmtStr('text.report.event_about')} key="3">
          <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
            ...
            <span className={utilitiesStyles['right']}>
              <a
                onClick={() => {
                  hashHistory.push('/report/eventDetail');
                }}
              >
                {crmIntlUtil.fmtStr('text.report.details')}
              </a>
          ...
          <TabPane tab={crmIntlUtil.fmtStr('text.report.coach_about')} key="4">
            ...
            >
              ...
              <span className={utilitiesStyles['right']}>
                <a
                  onClick={() => {
                    hashHistory.push('/report/coachDetail');
                  }}
                >
                  {crmIntlUtil.fmtStr('text.report.details')}
                </a>
