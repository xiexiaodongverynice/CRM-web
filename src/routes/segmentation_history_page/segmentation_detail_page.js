...
const SegmentationDetailRoutePage = ({ dispatch,  location, pageType, segmentationId, segmentationRecordData, secretJwtData }) => {
  return (
...
export default connect(mapStateToProps)(SegmentationDetailRoutePage);
