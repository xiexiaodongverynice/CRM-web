  ...
  return (
    <div className="k_container bg_white">
      ...
      <Table dataSource={datas} pagination={false} rowClassName={rowClassNameForSM(is_SM)}>
        ...
        />
        <Column
          title={crmIntlUtil.fmtStr('text.report.the_number_of_the_target_doctors_by_visit')}
          dataIndex="TargetCallNumber"
          key="TargetCallNumber"
        />
        <Column
          title={crmIntlUtil.fmtStr('text.report.the_number_of_the_non_target_doctors_by_visit')}
