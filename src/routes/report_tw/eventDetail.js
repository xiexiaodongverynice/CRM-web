...
import { handleResult, getDatas, rowClassNameForSM, handleRecord } from '../report/helpers';
    ...
    <div className="k_container bg_white">
      ...
      <Row className={cx(sizeStyles['height-50'], sizeStyles['lineHeight-50'], styles.toolbar)}>
        <span className={styles['text-item']}>
          {crmIntlUtil.fmtStr('text.report.number_of_the_mettings')}{_SM_text} {crmIntlUtil.fmtStr('text.report.report')}
        </span>
      </Row>
